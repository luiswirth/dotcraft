scoreboard players add @s lucky.phase 1
execute if entity @s[tag=lucky.meteor] run function lucky:stage/meteor
execute if entity @s[tag=lucky.stormcage] run function lucky:stage/stormcage
