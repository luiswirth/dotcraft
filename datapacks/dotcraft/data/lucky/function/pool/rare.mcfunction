...
execute if score #pick lucky.roll matches 11 run function lucky:outcome/monument
execute if score #pick lucky.roll matches 12 run function lucky:outcome/wildcard
